...
#'
#' @export
fun_Shiny_RelErrMom <- function(listData, period = c("days", "weeks", "months", "quarters", "years"),
                                lookback = c(3, 6, 12),
  ...
  Price_df_day <- zoo::na.locf(Price_df_day)

  Price_df_day <- Price_df_day[,stringr::str_replace_all(ChoosenAssets, ".CO", "")]
